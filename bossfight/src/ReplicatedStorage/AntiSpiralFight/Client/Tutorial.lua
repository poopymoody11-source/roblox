...
local function cards()
	...
	return {
		...
		{ Title = "HIS ULTIMATE", Keys = { click, pad() and "X" or "Q", pad() and "Y" or "E" }, Text = "WHEN HE WINDS UP SOMETHING HUGE, HIT EACH KEY AS IT APPEARS - OR BE ERASED", Color = Color3.fromRGB(255, 200, 80) },
	}
end
